            ...
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
                <DialogContent className="h-[70vh] flex flex-col sm:max-w-[700px]">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Masukkan hasil pemeriksaan fisik untuk{" "}
                            {examiningScreening?.name}.
                        </DialogDescription>
                    </DialogHeader>
                                ...
                                <div className="grid gap-4 py-4">
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center space-x-2">
                                                <RadioGroupItem
                                                    ...
                                                    id="tidak_direkomendasikan"
                                                />
                                                <Label htmlFor="tidak_direkomendasikan">
                                    ...
                                    <div className="grid grid-cols-4 items-center gap-4">
                                        <Label
                                            ...
                                            className="text-right"
                                        >
                                            Alasan (jika tidak direkomendasikan)
                                        </Label>
                                        <Input
                                            id="reason"
                                            value={data.reason}
                                    ...
                                    <div className="grid grid-cols-4 items-center gap-4">
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                <SelectItem value="sehat">
                                                    Sehat
                                                </SelectItem>
                                                <SelectItem value="tidak_sehat">
                                                    Tidak Sehat
                                                </SelectItem>
                                            </SelectContent>
                                        </Select>
                                    ...
                                    <div className="grid grid-cols-4 items-center gap-4">
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                <SelectItem value="pendampingan_perawat">
                                                    Pendampingan Perawat
                                                </SelectItem>
                                                <SelectItem value="pendampingan_paramedis">
                                                    Pendampingan Paramedis
                                                </SelectItem>
                                                <SelectItem value="pendampingan_dokter">
                                                    Pendampingan Dokter
                                                </SelectItem>
                                            </SelectContent>
                                        </Select>
                                    ...
                                    <div className="grid grid-cols-4 items-center gap-4">
                                        <Label
                                            htmlFor="konsultasi_dokter"
                                            className="text-right"
                                        >
                                            Konsultasi Dokter
                                        </Label>
                                        <Checkbox
                                            id="konsultasi_dokter"
                                            checked={!!data.konsultasi_dokter}

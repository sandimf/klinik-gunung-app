...
// Hapus import EditAnswerDialog dan EditPhysicalDialog
                                            ...
                                            <CardContent>
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <div className="flex flex-col gap-2">
                                                        ...
                                                        <span className="font-medium">{exam.physical_assessment}</span>
                                                    </div>
                                                    <div className="flex flex-col gap-2">
                                                    ...
                                                    <div className="flex flex-col gap-2">
                                                        ...
                                                        <span className="font-medium">
                                                            ...
                                                            {exam.health_status === "tidak_sehat" && "Tidak Layak"}
...
ScreeningDetails.propTypes = {
    ...
    questionsAndAnswers: PropTypes.arrayOf(PropTypes.shape({
        id: PropTypes.any, // Tidak wajib, tapi gunakan jika ada

...
import { FileText, Calendar, User, Phone, Info, Stethoscope } from 'lucide-react';
...
export default function ScreeningDetails({ patient, questionsAndAnswers, physicalExaminations }) {
    ...
    return (
        <SideBar header={`Detail kuesioner ${capitalizeWords(patient.name)}`}>
            ...
            <BackButton href={route('patients.doctor')} />
                                ...
                                <TableBody>
                                    {qaState.map((qa, index) => (
                                        <TableRow key={qa.id}>
                                            ...
                                            <TableCell>
                                                {/* EditAnswerDialog dihapus, hanya tampilkan jawaban */}
                                            </TableCell>
                                        </TableRow>
                                    ))}
                                </TableBody>

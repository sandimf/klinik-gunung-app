                ...
                <form onSubmit={handleSaveExamination}>
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            >
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="tidak_sehat_dengan_pendamping">Tidak Sehat</SelectItem>
                                    {/* <SelectItem value="tidak_sehat">Tidak Layak (Tanpa Pendampingan)</SelectItem> */}
                                </SelectContent>
                            </Select>
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <Select
                                value={data.medical_accompaniment}
                                onValueChange={(value) => setData('medical_accompaniment', value)}
                            >
                                <SelectTrigger className="col-span-3">
                                    <SelectValue placeholder="Pilih status kesehatan" />
                                </SelectTrigger>
                            ...
                            {errors.medical_accompaniment && <p className="text-red-500 text-sm col-span-4">{errors.medical_accompaniment}</p>}
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4">
                            <Label htmlFor="konsultasi_dokter" className="text-right">Konsultasi Dokter</Label>
                            <Checkbox id="konsultasi_dokter" value={data.consultation} onValueChange={(value) => setData('consultation', value)} />
                        </div>
                    </div>
                    <DialogFooter>

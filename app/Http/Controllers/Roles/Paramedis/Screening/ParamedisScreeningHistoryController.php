...
class ParamedisScreeningHistoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        $offline = DB::table('patients')
            ->select('patients.id', 'patients.uuid', 'patients.name', 'patients.screening_status', 'patients.health_status', 'q.queue')
            ->join(DB::raw('(
